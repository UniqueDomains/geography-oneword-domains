# One-Word Geography Domain Names Across 506 TLDs (105,526)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-105%2C526%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **105,526 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 105,526 domains · **Median ask:** $561.97 · **High-demand under $2,500:** 421
...
df = pd.read_csv("https://raw.githubusercontent.com/UniqueDomains/geography-oneword-domains/main/geography.csv")
print(df.head())
```
...
| map.bayern      | premium   | $117.53     | —             | high           | medium | 3      | name.com                      |
| map.democrat    | available | $9.99       | —             | high           | medium | 3      | name.com                      |
| map.berlin      | resell    | —           | —             | high           | medium | 3      | —                             |
| map.blog        | premium   | $1,625      | $6,500        | high           | medium | 3      | namecheap                     |
| map.desi        | available | $22.98      | —             | high           | medium | 3      | namecheap                     |
| map.blue        | resell    | —           | —             | high           | medium | 3      | Gandi SAS                     |
| map.boo         | premium   | $1,298.70   | $1,298.70     | high           | medium | 3      | namecheap                     |
| map.equipment   | available | $19.99      | —             | high           | medium | 3      | name.com                      |
| map.boats       | resell    | —           | —             | high           | medium | 3      | Namecheap                     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 105,526 live domains                       |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 421 high-demand names under $2,500         |
...
> Unique Domains. *One-Word Geography Domain Names Across 506 TLDs*. Version 2026-09-20. Public GitHub extract for the exact Unique Domains search represented by this repository.
